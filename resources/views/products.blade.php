                        ...
                        @can('admin')
                            <div class="flex gap-3 pl-4 mt-1">
                                ...
                                <a href="/product/{{ $product->id }}/edit"
                                    class="badge bg-white rounded-full w-6 h-6 mb-2 justify-center items-center flex">


                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-4 h-4"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <form action="/product/{{ $product->id }}" method="post" class="d-inline">
                                    ...
                                    <button onclick="return confirm('Are you sure?')"
                                        class="bg-white rounded-full w-6 h-6 mb-2 justify-center items-center flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-4 h-4"
                                            viewBox="0 0 24 24">
                                            <path
