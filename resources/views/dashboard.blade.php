    ...
    <section class="flex flex-col min-h-screen bg-center bg-cover bg-fixed bg-blend-overlay bg-white/30"
        ...
        <div class="flex-1 flex items-center">
            <div class="text-center mx-auto w-full md:w-2/3 lg:w-1/2 px-4">
                <h1 class="text-4xl md:text-7xl font-bold text-rose-800 font-abril drop-shadow-2xl">Welcome to Beauty
                    Navigator!</h1>
                <p class="font-light text-xl md:text-3xl mt-5 text-rose-700 font-abril drop-shadow-2xl">Your Navigator in
                    Beauty.</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-rose-100 p-[30px]  ">
        <div class=" border-[3px] border-rose-300 h-96 rounded-xl flex justify-center drop-shadow-2xl items-center p-3">
            ...
            <div class="flex-1 p-4 h-[350px]">
                ...
                <p class="font-abril text-lg">FInd My Makeup is one of our features for you as a smart solution to find
                    the makeup products that suit you best. In just a few clicks, we'll match your skin and preferences
                    with the perfect product for you, ensuring flawless results every time. Let us help bring out your
                    natural beauty and make you look stunning!</p>
        ...
        <div class="bg-white p-[30px] justify-center rounded-xl drop-shadow-2xl items-center flex flex-col">
            ...
            <div
                ...
                @foreach ($categories as $category)
                    <a href="/categories/{{ $category->id }}" class="flex flex-col items-center overflow-hidden">
                        <div
                        ...
                        <p class="mt-2 text-xl font-bold font-abril">{{ $category->nama }}</p>
                    </a>
                @endforeach
            </div>
            <div class="flex flex-col justify-center items-center">
                <h1 class="font-bold font-abril text-2xl text-rose-300 drop-shadow-xl text-center max-w-2xl">
                    Discover
                    your perfect products by exploring each category!</h1>
